...
ApplicationConfiguration.registerModule('benevoles', ['search']);
;
'use strict';
...
angular.module('interventions').config(
  ['FabSpeedDialServiceProvider', 'INTERVENTIONS', 'SearchServiceProvider', function (FabSpeedDialServiceProvider, INTERVENTIONS, SearchServiceProvider) {
